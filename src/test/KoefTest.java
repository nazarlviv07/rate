...
public class KoefTest {
	...
	public void testKoefFonbet() {
		...
		Assert.assertEquals(koef_fonbet.name_2, 31.00f);
		Assert.assertEquals(koef_fonbet.name_1X, 0f);
		Assert.assertEquals(koef_fonbet.name_12, 1.01f);
		Assert.assertEquals(koef_fonbet.name_X2, 7.80f);
		
		//Total
		Assert.assertEquals(koef_fonbet.name_TOTAL[0], 4.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe[0], 1.80f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe[0], 1.90f);
		Assert.assertEquals(koef_fonbet.name_TOTAL[1], 2.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe[1], 1.04f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe[1], 9.50f);
		Assert.assertEquals(koef_fonbet.name_TOTAL[2], 3.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe[2], 1.20f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe[2], 3.90f);
		Assert.assertEquals(koef_fonbet.name_TOTAL[3], 5.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe[3], 3.05f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe[3], 1.33f);
		Assert.assertEquals(koef_fonbet.name_TOTAL[4], 6.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe[4], 5.70f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe[4], 1.10f);
		
		
		// Ind Total
		Assert.assertEquals(koef_fonbet.name_IndTotalOfCommand1[0], 2.5f);
		Assert.assertEquals(koef_fonbet.name_IndTotalBilweOfCommand1[0], 1.19f);
		Assert.assertEquals(koef_fonbet.name_IndTotalMenweOfCommand1[0], 4.20f);
		Assert.assertEquals(koef_fonbet.name_IndTotalOfCommand1[2], 3.5f);
		Assert.assertEquals(koef_fonbet.name_IndTotalBilweOfCommand1[2], 1.85f);
		Assert.assertEquals(koef_fonbet.name_IndTotalMenweOfCommand1[2], 1.85f);
		Assert.assertEquals(koef_fonbet.name_IndTotalOfCommand2[0], 2.5f);
		Assert.assertEquals(koef_fonbet.name_IndTotalBilweOfCommand2[0], 9.00f);
		Assert.assertEquals(koef_fonbet.name_IndTotalMenweOfCommand2[0], 1.04f);
		Assert.assertEquals(koef_fonbet.name_IndTotalOfCommand2[2], 1.5f);
		Assert.assertEquals(koef_fonbet.name_IndTotalBilweOfCommand2[2], 3.10f);
		Assert.assertEquals(koef_fonbet.name_IndTotalMenweOfCommand2[2], 1.32f);

		// Fora
		Assert.assertEquals(koef_fonbet.name_FORA1[0], -2.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA1[0], 1.9f);
		Assert.assertEquals(koef_fonbet.name_FORA2[0], 2.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA2[0], 1.8f);
		Assert.assertEquals(koef_fonbet.name_FORA1[1], -4.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA1[1], 6.20f);
		Assert.assertEquals(koef_fonbet.name_FORA2[1], 4.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA2[1], 1.09f);
		Assert.assertEquals(koef_fonbet.name_FORA1[2], -3.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA1[2], 3.30f);
		Assert.assertEquals(koef_fonbet.name_FORA2[2], 3.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA2[2], 1.30f);
		Assert.assertEquals(koef_fonbet.name_FORA1[3], -1.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA1[3], 1.23f);
		Assert.assertEquals(koef_fonbet.name_FORA2[3], 1.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA2[3], 3.70f);
		
		// Perwuy time

		Assert.assertEquals(koef_fonbet.name_1_perwuy, 1.02f);
		Assert.assertEquals(koef_fonbet.name_X_perwuy, 0.0f);
		Assert.assertEquals(koef_fonbet.name_2_perwuy, 0.0f);
		Assert.assertEquals(koef_fonbet.name_1X_perwuy, 0.0f);
		Assert.assertEquals(koef_fonbet.name_12_perwuy, 0.0f);
		Assert.assertEquals(koef_fonbet.name_X2_perwuy, 14.00f);
		
		//Total
		Assert.assertEquals(koef_fonbet.name_TOTAL_perwuy[0], 2.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe_perwuy[0], 1.45f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe_perwuy[0], 2.55f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_perwuy[1], 3.5f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_bilwe_perwuy[1], 3.20f);
		Assert.assertEquals(koef_fonbet.name_TOTAL_menwe_perwuy[1], 1.30f);

		// Fora
		Assert.assertEquals(koef_fonbet.name_FORA1_perwuy[0], -2.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA1_perwuy[0], 2.60f);
		Assert.assertEquals(koef_fonbet.name_FORA2_perwuy[0], 2.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA2_perwuy[0], 1.45f);
		Assert.assertEquals(koef_fonbet.name_FORA1_perwuy[1], -1.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA1_perwuy[1], 1.18f);
		Assert.assertEquals(koef_fonbet.name_FORA2_perwuy[1], 1.5f);
		Assert.assertEquals(koef_fonbet.name_koef_for_FORA2_perwuy[1], 4.30f);
		
		// Ind Total
		Assert.assertEquals(koef_fonbet.name_IndTotalOfCommand1_perwuy[2], 2.5f);
		Assert.assertEquals(koef_fonbet.name_IndTotalBilweOfCommand1_perwuy[2], 1.98f);
		Assert.assertEquals(koef_fonbet.name_IndTotalMenweOfCommand1_perwuy[2], 1.72f);
	}
